...
class LogTimeTest extends \ExternalModules\ModuleBaseTest
{
	...
	public function removeRequestedBy($log) {
	...
	public function testCompareTimeLogs_requireUniqueCheckFields() {
		$assert = function ($a, $b) {
	...
	public function testCompareTimeLogs() {
	...
	public function assertCompareTimeLogs($assemblaLogs, $existingLogs, $assert) {
	...
	public function testArrayDeepDiff_itemOrder() {
	...
	public function testParseHoursSurveyProjectId() {
